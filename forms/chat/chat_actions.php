<div class="cms-actions btn-group">
  <a href="/chat/{{place}}/{{chat_id}}/" target="_blank" class="btn bg-transparent"><i class="fa fa-comments-o"></i></a>
  <!--
  ...
  <div class="dropdown-menu dropdown-menu-right">
    ...
    <a class="dropdown-item qr-get" href="/chat/{{place}}/{{chat_id}}/" target="_blank"><i class="fa fa-comments-o"></i> <span>Войти в чат</span></a>
