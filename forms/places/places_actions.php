<div class="cms-actions btn-group">
  <a class="btn bg-transparent qr-get" data-place="{{id}}"><i class="fa fa-qrcode"></i></a>
  ...
  <div class="dropdown-menu dropdown-menu-right">
    ...
    <a class="dropdown-item qr-get" href="javascript:void(0);" data-place="{{id}}">
      <i class="fa fa-qrcode"></i> <span>QR код</span></a>
